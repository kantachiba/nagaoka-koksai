...
/**
 * 外部アイコンライブラリを使わずに済ませるための最小限のアイコンセット。
 * すべて 24x24 / stroke ベースで統一しています。
 */
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  yen: (
    <>
      <path d="M6 4l6 8 6-8" />
      <path d="M7 13h10M7 17h10M12 12v8" />
    </>
  ),
  ...
  link: (
    <>
      <path d="M10 13.5a4 4 0 0 0 5.7.3l3-3a4 4 0 1 0-5.7-5.7L11.5 6.6" />
